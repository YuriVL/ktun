...
/* ==========================================================================
    ...
    $(document)
		.on('click', "#true_loadmore", function (e) {
			e.preventDefault();
            ...
            $.ajax({
                ...
                success:function(data){
                    if( data ) {
                        ...
                        $('#true_loadmore').closest('div').before(data); // вставляем новые посты
                        current_page++; // увеличиваем номер страницы на единицу
                        if (current_page == max_pages)
                            $('#true_loadmore').closest('div').remove(); // если последняя страница, удаляем кнопку
                    } else {
                        $('#true_loadmore').closest('div').remove(); // если мы дошли до последней страницы постов, скроем кнопку
                    }
                }
            });
        });
